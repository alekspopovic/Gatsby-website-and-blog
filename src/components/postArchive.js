              ...
              <AccordionItemPanel className={archiveStyles.accordionPanel}>
                <Accordion className={archiveStyles.innerAccordion}>
                  {Object.keys(history[year]).map(month => (
                    <AccordionItem
                      key={month}
                      className={archiveStyles.innerAccordionItem}
                    >
                      <AccordionItemButton
                        className={archiveStyles.innerAccordionButton}
                      >
                        {month}
                        <span>{history[year][month].postCount}</span>
                      </AccordionItemButton>
                      <AccordionItemPanel
                        className={archiveStyles.accordionPanel}
                      >
